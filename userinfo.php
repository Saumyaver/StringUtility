...
<tr>
    ...
    <td width="380"><input type="text" name="username" required="required" /></td>
  </tr>
  <tr>
    <td><span class="style1"><strong>Enter password:</strong></span></td>
    <td><input type="password" name="pwd" maxlength="8" required="required" /></td>
  </tr>
  <tr>
	...
	<tr>
		...
		<td colspan=4><input type="email" name="email" size=50 required="required"></td>
	</tr>
</table>
<br />
